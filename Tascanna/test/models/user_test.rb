...
class UserTest < ActiveSupport::TestCase
    ...
    test "password is less than 8 characters long so is not valid" do
    ...
    test "password is more than 25 characters long so is not valid" do
    ...
    test "password does not contain an uppercase letter so is not valid" do
    ...
    test "password does not contain a number so is not valid" do
    ...
    test "password does not contain a special character so is not valid" do
    ...
    test "user with no email and no password can not be saved" do
    ...
    test "user with valid email and no password can not be saved" do
    ...
    test "user with no email and valid password can not be saved" do
    ...
    test "user with valid email and valid password can be saved" do
