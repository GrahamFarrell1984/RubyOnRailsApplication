...
class UserTest < ActiveSupport::TestCase
    ...
    test "A user with no email and no password cannot be saved" do
    ...
    test "A user with valid email and no password cannot be saved" do
    ...
    test "A user with no email and valid password cannot be saved" do
